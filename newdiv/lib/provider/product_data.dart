...
class ProductsData with ChangeNotifier {
  ...
  findByID(String proId) {
    return _items.firstWhere((element) => element.id == proId);
  }
  ...
  updateProduct(String id, Product upPor) {
    final proIndex = _items.indexWhere((element) => element.id == id);
    if (proIndex >= 0) {
      _items[proIndex] = upPor;
    }
    notifyListeners();
  }

  deleteData(String proId) {
    _items.removeWhere((element) => element.id == proId);
  }
}
